/**
 * Buffers a file write and only writes it to the file systemonce all the links
 ...
 * their paths in the output directory. To fix this we allow the the markdown
 ...
 *
 * The {@link flush} method can be used to force all cached pages to be written to the
...
export default class PostProcessingService {
  public submit(content: string, path: string, pageId: string): void {}
  public flush(): void {}
